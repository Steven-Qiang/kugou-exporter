    ...
    <div class="app-body">
      ...
      <aside class="sidebar">
        ...
        <div v-loading="loading" class="playlist-list">
          ...
          <el-empty v-if="!loading && filteredPlaylists.length === 0" description="没有匹配的歌单" :image-size="72" />
        </div>
      </aside>
      ...
      <main class="main">
        ...
        <el-empty v-else class="main-empty" description="左侧选择歌单开始浏览" :image-size="120">
...
@media (max-width: 760px) {
  /* Phone layout: compress the top bar, stack the body, keep the playlist a
     horizontal strip, and let the song table scroll inside its own container. */
  .topbar {
    padding: 0 12px;
  }
